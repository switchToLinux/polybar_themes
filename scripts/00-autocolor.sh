...
# 格式:   [seprX] module1 seplXY module2 seplXY ... moduleN seplX
##############################################################
process_module_left_center() {
...
# 处理左侧模块
process_module_left_center "$modules_left"

# # 处理中间模块
process_module_left_center "$modules_center"
